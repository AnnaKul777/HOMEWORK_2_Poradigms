...
#     return result
 ...
 # Декларативный запрос для выборки имен и возрастов SELECT name, age FROM users WHERE age > 25;
...
# Напишите программу, которая находит сумму всех четных чисел от 1 до 100 с
# использованием императивного программирования (цикла).
...
# Напишите программу, которая находит сумму всех четных чисел от 1 до 100 с
# использованием декларативного программирования (цикла).

# even_numbers = [num for num in range(1, 101) if num % 2 == 0]
# sum_of_even_numbers = sum(even_numbers)
# print("Сумма равна: ", sum_of_even_numbers)
